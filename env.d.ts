/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 15d01b31ab531ba71abd871ad1fc43df)
...
interface __BaseEnv_Env {
	...
	JobAgent: DurableObjectNamespace<import("./src/server").JobAgent>;
	UsageGuard: DurableObjectNamespace<import("./src/server").UsageGuard>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "JobAgent" | "UsageGuard";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_MODEL" | "DAILY_AI_LIMIT" | "DEV_MODE" | "DATABASE_URL" | "SESSION_SECRET">> {}
}
