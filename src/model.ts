...
Exact mapping example: “Mid-level data engineering jobs from the last day” MUST call search_jobs with {"role_family":["Data engineering"],"seniority":["mid"],"posted_within":"day"}. Do not add other seniority levels and do not inherit the default week when the user names a day.
